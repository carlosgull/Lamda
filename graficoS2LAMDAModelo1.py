...
descriptores=2
datos=pd.read_csv('C:/Python/Doctorado/LAMDAClusS2Modelo.csv', header=0, delimiter=',')#Importación de datos
print(datos)
...
ax.set_title('Data S2 LAMDA Clustering', fontsize=20)
color_theme= np.array(['red', 'blue', 'black', 'red', 'orange', 'green', 'brown', 'purple'  , 'black' , 'maroon', 'gold', 'violet', 'wheat', 'lavender', 'coral' , 'khaki', 'plum'])
ax.scatter(x=pca_s1_df.Componente1 , y= pca_s1_df.Componente2, c=color_theme[pca_nombres_s1.Cluster], s=40, marker='.')
plt.savefig("S2LAMDAClus.png", transparent=True,  bbox_inches='tight', dpi=400)
plt.show()
