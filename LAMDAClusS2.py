...
datos=pandas.read_csv('C:/Python/doctorado/s2.csv', delimiter=';')#columnas del dataset
...
print(df1)
 #Dataframe normalizado para trabajar 788 individuos y 2 descriptores
...
ruta='C:\Python\doctorado\LAMDAClusS2Modelo.csv'#EXPORTACIÓN DE LOS RESULTADOS
...
color_theme= np.array(['red', 'blue', 'black', 'red', 'orange', 'green', 'brown', 'purple' 'maroon' , 'yellow', 'gold'])
